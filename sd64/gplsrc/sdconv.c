...
int main(int argc, char* argv[]) {
  ...
  printf(
      "[ SDCONV %s   Copyright, Ladybridge Systems, %s.  All rights reserved. "
      "]\n\n",
      SD_REV_STAMP, SD_COPYRIGHT_YEAR);
...
usage:
  printf("Usage: SDCONV {options} pathname(s)\n\n");
  printf("Options:\n");
